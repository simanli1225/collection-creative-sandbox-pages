...
exports.CalendarsImpl = void 0;
var timezone_1 = require("@phensley/timezone");
var calendars_1 = require("../systems/calendars");
var manager_1 = require("../internals/calendars/manager");
var render_1 = require("../utils/render");
var timezone_2 = require("../systems/calendars/timezone");
...
var CalendarsImpl = /** @class */ (function () {
    function CalendarsImpl(bundle, internals, privateApi) {
        ...
        this.manager = new manager_1.CalendarManager(bundle, internals);
    ...
    CalendarsImpl.prototype.toBuddhistDate = function (date) {
        return this.convertDate(calendars_1.BuddhistDate.fromUnixEpoch, date);
    };
    /**
    ...
    CalendarsImpl.prototype.newBuddhistDate = function (fields) {
        return calendars_1.BuddhistDate.fromFields(fields, this._firstDay, this._minDays);
    };
    /**
    ...
    CalendarsImpl.prototype.nowBuddhist = function (zoneId) {
        return calendars_1.BuddhistDate.fromUnixEpoch(new Date().getTime(), zoneId || '', this._firstDay, this._minDays);
    };
    /**
     * Convert the given date to the Gregorian calendar.
     */
    CalendarsImpl.prototype.toGregorianDate = function (date) {
        return this.convertDate(calendars_1.GregorianDate.fromUnixEpoch, date);
    };
    /**
    ...
    CalendarsImpl.prototype.newGregorianDate = function (fields) {
        return calendars_1.GregorianDate.fromFields(fields, this._firstDay, this._minDays);
    };
    /**
    ...
    CalendarsImpl.prototype.nowGregorian = function (zoneId) {
        return calendars_1.GregorianDate.fromUnixEpoch(new Date().getTime(), zoneId || '', this._firstDay, this._minDays);
    };
    /**
     * Convert the given date to the ISO-8601 calendar.
     */
    CalendarsImpl.prototype.toISO8601Date = function (date) {
        return this.convertDate(calendars_1.ISO8601Date.fromUnixEpoch, date);
    };
    /**
    ...
    CalendarsImpl.prototype.newISO8601Date = function (fields) {
        return calendars_1.ISO8601Date.fromFields(fields, this._firstDay, this._minDays);
    };
    /**
    ...
    CalendarsImpl.prototype.nowISO8601 = function (zoneId) {
        return calendars_1.ISO8601Date.fromUnixEpoch(new Date().getTime(), zoneId || '', this._firstDay, this._minDays);
    };
    /**
     * Convert the given date to the Japanese calendar.
     */
    CalendarsImpl.prototype.toJapaneseDate = function (date) {
        return this.convertDate(calendars_1.JapaneseDate.fromUnixEpoch, date);
    };
    /**
    ...
    CalendarsImpl.prototype.newJapaneseDate = function (fields) {
        return calendars_1.JapaneseDate.fromFields(fields, this._firstDay, this._minDays);
    };
    /**
    ...
    CalendarsImpl.prototype.nowJapanese = function (zoneId) {
        return calendars_1.JapaneseDate.fromUnixEpoch(new Date().getTime(), zoneId || '', this._firstDay, this._minDays);
    };
    /**
     * Convert the given date to the Persian calendar.
     */
    CalendarsImpl.prototype.toPersianDate = function (date) {
        return this.convertDate(calendars_1.PersianDate.fromUnixEpoch, date);
    };
    /**
     * Construct a new date in the Persian calendar with the given fields.
     */
    CalendarsImpl.prototype.newPersianDate = function (fields) {
        return calendars_1.PersianDate.fromFields(fields, this._firstDay, this._minDays);
    };
    /**
    ...
    CalendarsImpl.prototype.nowPersian = function (zoneId) {
        return calendars_1.PersianDate.fromUnixEpoch(new Date().getTime(), zoneId || '', this._firstDay, this._minDays);
    };
    /**
    ...
    CalendarsImpl.prototype.fieldOfVisualDifference = function (a, b) {
        ...
        // current locale.
        var type = a instanceof calendars_1.CalendarDate
            ? a.type()
            : b instanceof calendars_1.CalendarDate
                ? b.type()
        ...
        if (!(a instanceof calendars_1.CalendarDate) || type !== a.type()) {
            a = this.convertDateTo(type, a);
        }
        if (!(b instanceof calendars_1.CalendarDate) || type !== b.type() || a.timeZoneId() !== b.timeZoneId()) {
    ...
    CalendarsImpl.prototype.formatDate = function (date, options) {
        return this._formatDate(new render_1.StringValue(), date, options);
    };
    /**
    ...
    CalendarsImpl.prototype.formatDateToParts = function (date, options) {
        return this._formatDate(new render_1.PartsValue(), date, options);
    };
    CalendarsImpl.prototype.formatDateInterval = function (start, end, options) {
        return this._formatInterval(new render_1.StringValue(), start, end, options);
    };
    CalendarsImpl.prototype.formatDateIntervalToParts = function (start, end, options) {
        return this._formatInterval(new render_1.PartsValue(), start, end, options);
    };
    ...
    CalendarsImpl.prototype.formatDateRaw = function (date, options) {
        return this._formatDateRaw(new render_1.StringValue(), date, options || {});
    };
    CalendarsImpl.prototype.formatDateRawToParts = function (date, options) {
        return this._formatDateRaw(new render_1.PartsValue(), date, options || {});
    };
    CalendarsImpl.prototype.formatDateWrapper = function (date, time, options) {
        return this._formatDateWrapper(new render_1.StringValue(), date, time, options || {});
    };
    CalendarsImpl.prototype.formatDateWrapperToParts = function (date, time, options) {
        return this._formatDateWrapper(new render_1.PartsValue(), date, time, options || {});
    };
    ...
    CalendarsImpl.prototype.timeZoneIds = function () {
        return timezone_1.TZ.zoneIds();
    };
    CalendarsImpl.prototype.resolveTimeZoneId = function (zoneid) {
        return timezone_1.TZ.resolveId((0, timezone_2.substituteZoneAlias)(zoneid));
    };
    CalendarsImpl.prototype.timeZoneInfo = function (zoneid) {
        ...
        var stableid = (0, timezone_2.getStableTimeZoneId)(id);
        var city = this.exemplarCities[stableid] || this.exemplarCities['Etc/Unknown'];
        var metazone = ((0, timezone_2.currentMetazone)(id) || '');
        var names = {
            long: { generic: '', standard: '', daylight: '' },
            short: { generic: '', standard: '', daylight: '' },
        };
        for (var _i = 0, _a = schema_1.TimeZoneTypeIndex.keys; _i < _a.length; _i++) {
            var key = _a[_i];
        ...
        var _b = timezone_1.TZ.zoneMeta(id), countries = _b.countries, latitude = _b.latitude, longitude = _b.longitude, stdoffset = _b.stdoffset; // Factory fallback will return a record
        return {
            id: id,
            city: {
                name: city,
    ...
    CalendarsImpl.prototype.timeZoneFromUTC = function (utc, zoneid) {
        return timezone_1.TZ.fromUTC(zoneid, utc);
    };
    CalendarsImpl.prototype.timeZoneFromWall = function (wall, zoneid) {
        return timezone_1.TZ.fromWall(zoneid, wall);
    };
    CalendarsImpl.prototype.timePeriodToQuantity = function (period) {
        var q = [];
        for (var _i = 0, TIME_PERIOD_FIELDS_1 = calendars_1.TIME_PERIOD_FIELDS; _i < TIME_PERIOD_FIELDS_1.length; _i++) {
    ...
    CalendarsImpl.prototype.convertDate = function (cons, date) {
        ...
        return date instanceof calendars_1.CalendarDate
    ...
    CalendarsImpl.prototype.convertDateTo = function (target, date, zoneId) {
        if (date instanceof calendars_1.CalendarDate && target === date.type() && (!zoneId || zoneId === date.timeZoneId())) {
            return date;
        }
...
exports.CalendarsImpl = CalendarsImpl;
