...
var NumbersImpl = /** @class */ (function () {
    ...
    NumbersImpl.prototype.adjustDecimal = function (n, opts) {
        return this.numbers.adjustDecimal((0, decimal_1.coerceDecimal)(n), opts);
    };
    NumbersImpl.prototype.parseDecimal = function (n) {
        return (0, decimal_1.coerceDecimal)(n);
    };
    ...
    NumbersImpl.prototype.getCurrencyFractions = function (code) {
        return (0, internals_1.getCurrencyFractions)(code);
    };
    NumbersImpl.prototype.getCurrencyForRegion = function (region) {
        return (0, internals_1.getCurrencyForRegion)(region);
    };
    ...
    NumbersImpl.prototype.getPluralCardinal = function (n, options) {
        var d = options ? this.adjustDecimal(n, options) : (0, decimal_1.coerceDecimal)(n);
    ...
    NumbersImpl.prototype.formatCurrencyImpl = function (renderer, params, n, code, options) {
        ...
        return this.numbers.formatCurrency(this.bundle, renderer, (0, decimal_1.coerceDecimal)(n), code, options, params);
    };
    return NumbersImpl;
}());
