...
var PersianDate = /** @class */ (function (_super) {
    tslib_1.__extends(PersianDate, _super);
    ...
    PersianDate.prototype.set = function (fields) {
        var f = tslib_1.__assign(tslib_1.__assign({}, this.fields()), fields);
    ...
    PersianDate.fromFields = function (fields, firstDay, minDays) {
        return new PersianDate(firstDay, minDays).set(tslib_1.__assign({ year: 1, month: 1, day: 1 }, fields));
    };
...
var leapPersian = function (y) {
    var rem = [0];
    (0, utils_1.floorDiv)(25 * y + 11, 33, rem);
    return rem[0] < 8;
};
