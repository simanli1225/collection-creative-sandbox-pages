...
var relativeField = function (p) {
    for (var _i = 0, TIME_PERIOD_FIELDS_1 = interval_1.TIME_PERIOD_FIELDS; _i < TIME_PERIOD_FIELDS_1.length; _i++) {
...
var CalendarDate = /** @class */ (function () {
    ...
    CalendarDate.prototype._invertPeriod = function (fields) {
        var r = {};
        for (var _i = 0, TIME_PERIOD_FIELDS_2 = interval_1.TIME_PERIOD_FIELDS; _i < TIME_PERIOD_FIELDS_2.length; _i++) {
    ...
    CalendarDate.prototype._rollup = function (span, sf, ef, fields) {
        var f = (0, interval_1.timePeriodFieldFlags)(fields);
        if (!f) {
            return tslib_1.__assign({ year: 0, month: 0, week: 0, day: 0, hour: 0, minute: 0, second: 0, millis: 0 }, span);
        }
    ...
    CalendarDate.prototype.initFromUnixEpoch = function (ms, zoneId) {
        zoneId = (0, timezone_1.substituteZoneAlias)(zoneId);
        this._zoneInfo = (0, timezone_1.zoneInfoFromUTC)(zoneId, ms);
