...
var JapaneseDate = /** @class */ (function (_super) {
    tslib_1.__extends(JapaneseDate, _super);
...
var computeJapaneseFields = function (f) {
    ...
    if (year > ERAS[len - 3]) {
        ...
        while (low < high - 1) {
            ...
            if (diff === 0) {
                diff = f[7 /* DateField.MONTH */] - 1 - (ERAS[j + 1] - 1);
                if (diff === 0) {
                    diff = f[10 /* DateField.DAY_OF_MONTH */] - ERAS[j + 2];
                }
            }
            if (diff >= 0) {
                low = i;
    ...
    f[2 /* DateField.ERA */] = low;
    f[4 /* DateField.YEAR */] = year - ERAS[low * 3] + 1;
};
// prettier-ignore
var ERAS = [
    645, 6, 19, // Taika
