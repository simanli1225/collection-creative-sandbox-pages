...
exports.buildSchema = exports.SchemaBuilder = void 0;
...
var time = function (n) { return new decimal_1.Decimal(n[0]).add(new decimal_1.Decimal(n[1]).movePoint(-9)); };
...
var SchemaBuilder = /** @class */ (function () {
    ...
    SchemaBuilder.prototype.constructDigits = function (obj, inst) {
        ...
        obj[inst.name] = new schema_1.DigitsArrowImpl(offset, dim0, inst.values);
    };
    SchemaBuilder.prototype.constructField = function (obj, inst) {
        var offset = this.generator.field();
        obj[inst.name] = new schema_1.FieldArrowImpl(offset);
    };
    SchemaBuilder.prototype.constructOrigin = function (obj, inst) {
        ...
        if (capture) {
            ...
            for (var _b = 0, _c = this._times; _b < _c.length; _b++) {
                var t = _c[_b];
                console.log((0, string_1.leftPad)(t[0], 20), t[1]);
            }
        }
    };
    ...
    SchemaBuilder.prototype.constructScopeMap = function (obj, inst) {
        ...
        obj[inst.name] = new schema_1.ScopeArrowImpl(map);
    };
    SchemaBuilder.prototype.constructVector = function (obj, inst) {
        ...
        obj[inst.name] = new schema_1.VectorArrowImpl(offset, dims);
    };
