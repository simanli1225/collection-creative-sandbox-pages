...
exports.CURRENCY_SPACING_MATCHERS = exports.RE_DIGIT = exports.RE_SYMBOL = exports.PartsNumberFormatter = exports.StringNumberFormatter = exports.NumberFormatter = void 0;
var tslib_1 = require("tslib");
var decimal_1 = require("@phensley/decimal");
var numbering_1 = require("../../systems/numbering");
        ...
        for (var _i = 0, _a = pattern.nodes; _i < _a.length; _i++) {
            ...
            if (typeof node === 'string') {
                ...
                switch (node) {
                    ...
                    case 0 /* NumberField.MINUS */:
                        res.add('minus', symbols.minusSign);
                        break;
                    case 5 /* NumberField.PLUS */:
                        res.add('plus', symbols.plusSign);
                        break;
                    case 3 /* NumberField.NUMBER */:
                        res.append(formatted);
                        haveNumber = true;
                        break;
                    case 1 /* NumberField.PERCENT */:
                        res.add('percent', percentSymbol);
                        break;
                    case 4 /* NumberField.EXPONENT */:
                        ...
                        if (exponent) {
                            ...
                            var exp = (0, numbering_1.fastFormatDecimal)("".concat(exponent), this.params.digits, 1);
                            res.add('integer', exp);
                            break;
                        }
                }
...
var DECIMAL_DIGIT_NUMBER = /\u0030-\u0039\u0660-\u0669\u06f0-\u06f9\u07c0-\u07c9\u0966-\u096f\u09e6-\u09ef\u0a66-\u0a6f\u0ae6-\u0aef\u0b66-\u0b6f\u0be6-\u0bef\u0c66-\u0c6f\u0ce6-\u0cef\u0d66-\u0d6f\u0de6-\u0def\u0e50-\u0e59\u0ed0-\u0ed9\u0f20-\u0f29\u1040-\u1049\u1090-\u1099\u17e0-\u17e9\u1810-\u1819\u1946-\u194f\u19d0-\u19d9\u1a80-\u1a89\u1a90-\u1a99\u1b50-\u1b59\u1bb0-\u1bb9\u1c40-\u1c49\u1c50-\u1c59\ua620-\ua629\ua8d0-\ua8d9\ua900-\ua909\ua9d0-\ua9d9\ua9f0-\ua9f9\uaa50-\uaa59\uabf0-\uabf9\uff10-\uff19/;
var MATH_SYMBOL = /\u002b\u003c-\u003e\u007c\u007e\u00ac\u00b1\u00d7\u00f7\u03f6\u0606-\u0608\u2044\u2052\u207a-\u207c\u208a-\u208c\u2118\u2140-\u2144\u214b\u2190-\u2194\u219a-\u219b\u21a0\u21a3\u21a6\u21ae\u21ce-\u21cf\u21d2\u21d4\u21f4-\u22ff\u2320-\u2321\u237c\u239b-\u23b3\u23dc-\u23e1\u25b7\u25c1\u25f8-\u25ff\u266f\u27c0-\u27c4\u27c7-\u27e5\u27f0-\u27ff\u2900-\u2982\u2999-\u29d7\u29dc-\u29fb\u29fe-\u2aff\u2b30-\u2b44\u2b47-\u2b4c\ufb29\ufe62\ufe64-\ufe66\uff0b\uff1c-\uff1e\uff5c\uff5e\uffe2\uffe9-\uffec/;
var CURRENCY_SYMBOL = /\u0024\u00a2-\u00a5\u058f\u060b\u07fe-\u07ff\u09f2-\u09f3\u09fb\u0af1\u0bf9\u0e3f\u17db\u20a0-\u20bf\ua838\ufdfc\ufe69\uff04\uffe0-\uffe1\uffe5-\uffe6/;
var MODIFIER_SYMBOL = /\u005e\u0060\u00a8\u00af\u00b4\u00b8\u02c2-\u02c5\u02d2-\u02df\u02e5-\u02eb\u02ed\u02ef-\u02ff\u0375\u0384-\u0385\u1fbd\u1fbf-\u1fc1\u1fcd-\u1fcf\u1fdd-\u1fdf\u1fed-\u1fef\u1ffd-\u1ffe\u309b-\u309c\ua700-\ua716\ua720-\ua721\ua789-\ua78a\uab5b\uab6a-\uab6b\ufbb2-\ufbc1\uff3e\uff40\uffe3/;
var OTHER_SYMBOL = /\u00a6\u00a9\u00ae\u00b0\u0482\u058d-\u058e\u060e-\u060f\u06de\u06e9\u06fd-\u06fe\u07f6\u09fa\u0b70\u0bf3-\u0bf8\u0bfa\u0c7f\u0d4f\u0d79\u0f01-\u0f03\u0f13\u0f15-\u0f17\u0f1a-\u0f1f\u0f34\u0f36\u0f38\u0fbe-\u0fc5\u0fc7-\u0fcc\u0fce-\u0fcf\u0fd5-\u0fd8\u109e-\u109f\u1390-\u1399\u166d\u1940\u19de-\u19ff\u1b61-\u1b6a\u1b74-\u1b7c\u2100-\u2101\u2103-\u2106\u2108-\u2109\u2114\u2116-\u2117\u211e-\u2123\u2125\u2127\u2129\u212e\u213a-\u213b\u214a\u214c-\u214d\u214f\u218a-\u218b\u2195-\u2199\u219c-\u219f\u21a1-\u21a2\u21a4-\u21a5\u21a7-\u21ad\u21af-\u21cd\u21d0-\u21d1\u21d3\u21d5-\u21f3\u2300-\u2307\u230c-\u231f\u2322-\u2328\u232b-\u237b\u237d-\u239a\u23b4-\u23db\u23e2-\u2426\u2440-\u244a\u249c-\u24e9\u2500-\u25b6\u25b8-\u25c0\u25c2-\u25f7\u2600-\u266e\u2670-\u2767\u2794-\u27bf\u2800-\u28ff\u2b00-\u2b2f\u2b45-\u2b46\u2b4d-\u2b73\u2b76-\u2b95\u2b97-\u2bff\u2ce5-\u2cea\u2e50-\u2e51\u2e80-\u2e99\u2e9b-\u2ef3\u2f00-\u2fd5\u2ff0-\u2ffb\u3004\u3012-\u3013\u3020\u3036-\u3037\u303e-\u303f\u3190-\u3191\u3196-\u319f\u31c0-\u31e3\u3200-\u321e\u322a-\u3247\u3250\u3260-\u327f\u328a-\u32b0\u32c0-\u33ff\u4dc0-\u4dff\ua490-\ua4c6\ua828-\ua82b\ua836-\ua837\ua839\uaa77-\uaa79\ufdfd\uffe4\uffe8\uffed-\uffee\ufffc-\ufffd/;
 ...
 * @internal
 */
exports.RE_SYMBOL = new RegExp("^[".concat(MATH_SYMBOL.source).concat(CURRENCY_SYMBOL.source).concat(MODIFIER_SYMBOL.source).concat(OTHER_SYMBOL.source).concat(SPACE_SEPARATOR).concat(LINE_SEPARATOR).concat(PARAGRAPH_SEPARATOR, "]"));
/* eslint-enable max-len */
/**
 * @internal
 */
exports.RE_DIGIT = new RegExp("^[".concat(DECIMAL_DIGIT_NUMBER.source, "]"));
/**
 * @internal
 */
exports.CURRENCY_SPACING_MATCHERS = {
    ...
    '[:digit:]': function (s) { return exports.RE_DIGIT.test(s); },
    '[[:^S:]&[:^Z:]]': function (s) { return !exports.RE_SYMBOL.test(s); },
};
