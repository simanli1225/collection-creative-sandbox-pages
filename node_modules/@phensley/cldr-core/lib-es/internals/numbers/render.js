...
import { PartsDecimalFormatter, StringDecimalFormatter } from '@phensley/decimal';
                ...
                switch (node) {
                    ...
                    case 4 /* NumberField.EXPONENT */:
                        ...
                        if (exponent) {
                            ...
                            var exp = fastFormatDecimal("".concat(exponent), this.params.digits, 1);
                            res.add('integer', exp);
                            break;
                        }
                }
 ...
 * @internal
 */
export var RE_SYMBOL = new RegExp("^[".concat(MATH_SYMBOL.source).concat(CURRENCY_SYMBOL.source).concat(MODIFIER_SYMBOL.source).concat(OTHER_SYMBOL.source).concat(SPACE_SEPARATOR).concat(LINE_SEPARATOR).concat(PARAGRAPH_SEPARATOR, "]"));
/* eslint-enable max-len */
/**
 * @internal
 */
export var RE_DIGIT = new RegExp("^[".concat(DECIMAL_DIGIT_NUMBER.source, "]"));
/**
 * @internal
 */
export var CURRENCY_SPACING_MATCHERS = {
    ...
    '[[:^S:]&[:^Z:]]': function (s) { return !RE_SYMBOL.test(s); },
};
