import { DATE_PATTERN_CHARS } from '../../parsing/date';
import { getFieldType, skeletonFields, EXTRA_FIELD, FIELD_INDEX, FIELD_TYPES, MISSING_FIELD, } from './fields';
/**
...
export { DateSkeleton };
export var EMPTY = new DateSkeleton();
