...
exports.parseLanguageTag = void 0;
var tslib_1 = require("tslib");
var languagetag_1 = require("./languagetag");
var util_1 = require("./util");
var subtags = tslib_1.__importStar(require("./autogen.subtags"));
// Subtag separator
var SEP = '-';
var UNDERSCORE = /_/g;
...
var LanguageTagParser = /** @class */ (function () {
    ...
    LanguageTagParser.prototype.parse = function () {
        ...
        return new languagetag_1.LanguageTag(this.language, this.script, this.region, this.variants.length === 0 ? undefined : this.variants[0], this.extensions, this.privateUse, this.extlangs);
    };
