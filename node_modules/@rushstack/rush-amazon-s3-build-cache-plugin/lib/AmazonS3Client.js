...
class AmazonS3Client {
    ...
    async _makeRequestAsync(verb, objectName, body) {
        ...
        this._writeDebugLine(terminal_1.Colorize.bold('Canonical URI: '), canonicalUri);
        if (this._credentials) {
        ...
        this._writeDebugLine(terminal_1.Colorize.bold(terminal_1.Colorize.underline('Sending request to S3')));
        this._writeDebugLine(terminal_1.Colorize.bold('HOST: '), url);
        ...
        if (response.hasNetworkError) {
            if (storageRetryOptions && storageRetryOptions.maxTries > 1) {
                ...
                async function retry(retryAttempt) {
                    ...
                    await node_core_library_1.Async.sleepAsync(delay);
