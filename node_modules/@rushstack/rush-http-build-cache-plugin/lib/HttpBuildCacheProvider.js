    ...
    async _makeHttpRequestAsync(options) {
        ...
        if (!response.ok) {
            ...
            if (!isNonCredentialResponse &&
                ...
                return await this._makeHttpRequestAsync(Object.assign(Object.assign({}, options), { credentialOptions: CredentialsOptions.Required }));
            }
            if (options.maxAttempts > 1) {
                ...
                return await this._makeHttpRequestAsync(Object.assign(Object.assign({}, options), { maxAttempts: options.maxAttempts - 1 }));
            }
