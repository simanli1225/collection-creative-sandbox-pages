...
const rush_project_schema_json_1 = __importDefault(require("../schemas/rush-project.schema.json"));
const rush_project_schema_json_2 = __importDefault(require("../schemas/rush-project.schema.json"));
const RUSH_PROJECT_CONFIGURATION_FILE = new heft_config_file_1.ConfigurationFile({
    projectRelativeFilePath: `config/${RushConstants_1.RushConstants.rushProjectConfigFilename}`,
    jsonSchemaObject: rush_project_schema_json_1.default,
    propertyInheritance: {
        operationSettings: {
...
const OLD_RUSH_PROJECT_CONFIGURATION_FILE = new heft_config_file_1.ConfigurationFile({
    ...
    jsonSchemaObject: rush_project_schema_json_2.default
});
/**
...
class RushProjectConfiguration {
    ...
    getCacheDisabledReason(trackedFileNames, phaseName, isNoOp) {
        ...
        const normalizedProjectRelativeFolder = node_core_library_1.Path.convertToSlashes(this.project.projectRelativeFolder);
    ...
    static getCacheDisabledReasonForProject(options) {
        ...
        if (!projectConfiguration) {
            return (`Project does not have a ${RushConstants_1.RushConstants.rushProjectConfigFilename} configuration file, ` +
    ...
    static async tryLoadForProjectsAsync(projects, terminal) {
        ...
        await node_core_library_1.Async.forEachAsync(projects, async (project) => {
