...
class PurgeManager {
    constructor(rushConfiguration, rushGlobalFolder) {
        ...
        this.commonTempFolderRecycler = new AsyncRecycler_1.AsyncRecycler(commonAsyncRecyclerPath);
    ...
    purgeUnsafe() {
        ...
        if (this._rushConfiguration.packageManager === 'pnpm' &&
            ...
            // eslint-disable-next-line no-console
            console.warn(terminal_1.Colorize.yellow(`Purging the global pnpm-store`));
        ...
        if (!path.isAbsolute(relative)) {
            ...
            if (firstPart.length > 0 && firstPart !== '..') {
                ...
                if (showWarning) {
                    ...
                    // eslint-disable-next-line no-console
                    console.log(terminal_1.Colorize.yellow("The active process's folder will not be deleted: " + path.join(folderToRecycle, firstPart)));
                }
            }
        }
