...
exports.PnpmShrinkwrapFile = exports.normalizePnpmVersionSpecifier = exports.parsePnpmDependencyKey = void 0;
...
class PnpmShrinkwrapFile extends BaseShrinkwrapFile_1.BaseShrinkwrapFile {
    ...
    _convertLockfileV6DepPathToV5DepPath(newDepPath) {
        ...
        if (newDepPath.includes('(') && index > dependencyPath.indexOfPeersSuffix(newDepPath))
            return newDepPath;
    ...
    async isWorkspaceProjectModifiedAsync(project, subspace, variant) {
        ...
        if (this.shrinkwrapFileMajorVersion < 6) {
            ...
            for (const { name, injected } of dependencyMetaList) {
                if (((_r = (_q = importer.dependenciesMeta) === null || _q === void 0 ? void 0 : _q[name]) === null || _r === void 0 ? void 0 : _r.injected) === injected) {
