...
class VersionAction extends BaseRushAction_1.BaseRushAction {
    ...
    async runAsync() {
        ...
        this._validateInput();
        const versionManagerModule = await Promise.resolve().then(() => __importStar(require(
    ...
    async _gitProcessAsync(tempBranch, targetBranch, variant) {
        ...
        if (changeLogUpdated) {
            ...
            await publishGit.commitAsync(this.rushConfiguration.gitChangeLogUpdateCommitMessage || exports.DEFAULT_CHANGELOG_UPDATE_MESSAGE, !this._ignoreGitHooksParameter.value);
        }
        ...
        if (packageJsonUpdated) {
            ...
            await publishGit.commitAsync(this.rushConfiguration.gitVersionBumpCommitMessage || exports.DEFAULT_PACKAGE_UPDATE_MESSAGE, !this._ignoreGitHooksParameter.value);
        }
