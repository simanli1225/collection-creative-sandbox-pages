...
class PhasedScriptAction extends BaseScriptAction_1.BaseScriptAction {
    ...
    async runAsync() {
        ...
        if (this._alwaysInstall || ((_a = this._installParameter) === null || _a === void 0 ? void 0 : _a.value)) {
            const { doBasicInstallAsync } = await Promise.resolve().then(() => __importStar(require(
        ...
        try {
            ...
            const relevantProjects = Selection_1.Selection.expandAllDependencies(projectSelection);
            const projectConfigurations = this
                ._runsBeforeInstall
                ? new Map()
                : await RushProjectConfiguration_1.RushProjectConfiguration.tryLoadForProjectsAsync(relevantProjects, terminal);
    ...
    async _runInitialPhasesAsync(options) {
        ...
        const analyzer = new ProjectChangeAnalyzer_1.ProjectChangeAnalyzer(this.rushConfiguration);
