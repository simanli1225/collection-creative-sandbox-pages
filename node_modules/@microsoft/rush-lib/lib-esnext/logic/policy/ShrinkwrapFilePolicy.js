...
export function validate(rushConfiguration, subspace, variant, options) {
    ...
    const shrinkwrapFile = ShrinkwrapFileFactory.getShrinkwrapFile(rushConfiguration.packageManager, rushConfiguration.packageManagerOptions, subspace.getCommittedShrinkwrapFilePath(variant));
    if (!shrinkwrapFile) {
        // eslint-disable-next-line no-console
