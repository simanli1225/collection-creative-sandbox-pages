...
export class WorkspaceInstallManager extends BaseInstallManager {
    ...
    async prepareCommonTempAsync(subspace, shrinkwrapFile) {
            ...
            for (const { name, version, dependencyType } of [
                ...
                if ((dependencySpecifier.specifierType === DependencySpecifierType.Version ||
                    ...
                    if (!semver.satisfies(referencedLocalProject.packageJsonEditor.version, dependencySpecifier.versionSpecifier)) {
                        ...
                        console.log();
                        // eslint-disable-next-line no-console
                        console.log(Colorize.red(`"${rushProject.packageName}" depends on package "${name}" (${version}) which exists ` +
        ...
        const overridesAreEqual = objectsAreDeepEqual((_a = this.rushConfiguration.pnpmOptions.globalOverrides) !== null && _a !== void 0 ? _a : {}, (shrinkwrapFile === null || shrinkwrapFile === void 0 ? void 0 : shrinkwrapFile.overrides) ? Object.fromEntries(shrinkwrapFile === null || shrinkwrapFile === void 0 ? void 0 : shrinkwrapFile.overrides) : {});
    ...
    async postInstallAsync(subspace) {
        ...
        const tempShrinkwrapFile = ShrinkwrapFileFactory.getShrinkwrapFile(this.rushConfiguration.packageManager, this.rushConfiguration.pnpmOptions, subspace.getTempShrinkwrapFilename());
