...
exports.sendEvent = exports.listenForEvents = exports.UniversalStateEventType = void 0;
 ...
 */
var UniversalStateEventType = exports.UniversalStateEventType = /*#__PURE__*/function (UniversalStateEventType) {
...
var extractConsumableMessage = (messageEvent, expectedWindow) => {
  ...
  if (messageEvent.origin !== window.location.origin) {
    _log.default.warn('Received event from different origin ' + "(".concat(messageEvent.origin, " !== ").concat(window.location.origin, "). ") + 'Discarding.');
    return null;
  }
 ...
 */
var sendEvent = (otherWindow, event) => {
  var message = {
...
var listenForEvents = (otherWindow, callback) => {
