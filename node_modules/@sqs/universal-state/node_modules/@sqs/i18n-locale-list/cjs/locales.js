 ...
 * Additionally it does not have the concept of "beta" locales because
 * its intended usage is for build configurations (the number of language available to build).
 * There is some validation logic in FEBs that ensures you only build what’s available inside `translationFiles`.
 * The actual updating of builds is independent of that list so it should be safe to update
 * as long as there are no unintended usages (which should be checked prior to updating)
 *
 ...
 */
var supportedTranslationLocales = ['en-US', 'es-419', 'fr-FR', 'de-DE', 'pt-BR', 'it-IT', 'nl-NL', 'sv-SE', 'no-NO', 'fi-FI', 'da-DK', 'ja-JP', 'tr-TR'];
var supportedLanguageTags = ['en', 'es', 'fr', 'de', 'pt', 'it', 'nl', 'sv', 'no', 'fi', 'da', 'ja', 'tr'];
var memberEnabledLocales = ['en-US', 'de-DE', 'fr-FR', 'es-419', 'pt-BR', 'it-IT', 'ja-JP'];
var memberBetaLocales = ['tr-TR'];
var visitorEnabledLocales = ['da-DK', 'da-GL', 'de-AT', 'de-CH', 'de-DE', 'de-LU', 'en-AU', 'en-CA', 'en-GB', 'en-IE', 'en-IN', 'en-NZ', 'en-US', 'en-ZA', 'es-AR', 'es-BO', 'es-CL', 'es-CO', 'es-CR', 'es-DO', 'es-EC', 'es-ES', 'es-GT', 'es-HN', 'es-MX', 'es-NI', 'es-PA', 'es-PE', 'es-PR', 'es-PY', 'es-SV', 'es-UY', 'es-VE', 'fi-FI', 'fr-BE', 'fr-CA', 'fr-CH', 'fr-FR', 'fr-LU', 'it-CH', 'it-IT', 'ja-JP', 'nl-BE', 'nl-NL', 'no-NO', 'pt-BR', 'pt-PT', 'sv-SE'];
var visitorBetaLocales = ['tr-TR'];
...
var LOCALES = {
  member: {
    all: [].concat(memberEnabledLocales, memberBetaLocales),
    beta: [].concat(memberBetaLocales),
    enabled: [].concat(memberEnabledLocales)
  },
  visitor: {
    all: [].concat(visitorEnabledLocales, visitorBetaLocales),
    beta: [].concat(visitorBetaLocales),
    enabled: [].concat(visitorEnabledLocales)
  },
