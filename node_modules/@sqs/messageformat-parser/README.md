# @sqs/messageformat-parser

### This repository is a fork from https://github.com/messageformat/parser.git
...
```sh
npm install @sqs/messageformat-parser
```
...
```js
> var parse = require('@sqs/messageformat-parser').parse;
