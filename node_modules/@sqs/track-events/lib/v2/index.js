...
import { SourceEnvironment } from '../types';
import { getDefaultConfig } from './constants/defaultConfig';
import { maybeNavigator, maybeProcess } from '../util';
...
var EventsClient = /*#__PURE__*/function (_BaseClient) {
   ...
   * @param {string} defaultPayload.member_account_locale - The authenticated user’s locale setting
  ...
  return _createClass(EventsClient, [{
    ...
    value: function _generatePayload(event) {
      ...
      var sessionInfo = getSessionInfo(isCookieEnabled);
      ...
      var context_website_id = defaultAndEvent.context_website_id,
        ...
        restOfDefaultAndEvent = _objectWithoutProperties(defaultAndEvent, _excluded);
      var autoPopulatedFields = {
        ...
        marketing_id: cookie.get('SS_MID') || null,
      ...
      var isJestEnv = Boolean((_maybeProcess = maybeProcess()) === null || _maybeProcess === void 0 || (_maybeProcess = _maybeProcess.env) === null || _maybeProcess === void 0 ? void 0 : _maybeProcess.JEST_WORKER_ID);
    ...
    value: function _generateUrl() {
      var _maybeProcess2;
      var isJestEnv = Boolean((_maybeProcess2 = maybeProcess()) === null || _maybeProcess2 === void 0 || (_maybeProcess2 = _maybeProcess2.env) === null || _maybeProcess2 === void 0 ? void 0 : _maybeProcess2.JEST_WORKER_ID);
      if (isJestEnv) {
...
export var SiteVisitorClient = /*#__PURE__*/function (_EventsClient) {
  function SiteVisitorClient(config) {
    var defaultPayload = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    _classCallCheck(this, SiteVisitorClient);
    return _callSuper(this, SiteVisitorClient, [_objectSpread(_objectSpread({}, config), {}, {
      setAnalyticsCookie: false
    }), defaultPayload]);
  }
  _inherits(SiteVisitorClient, _EventsClient);
  return _createClass(SiteVisitorClient);
}(EventsClient);