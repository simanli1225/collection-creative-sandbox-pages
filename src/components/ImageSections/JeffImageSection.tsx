    ...
    <section data-theme={dataTheme} className={styles.section}>
      ...
      <div className={styles.gridSection}>
        ...
        <div className={styles.gridItem + ' ' + styles.text}>
          ...
          <Video src="https://storage.cloud.google.com/fdfc-www-prod-001-media-www/images/pages/creative-sandbox/collections/jeff-koons/gallery/3D%20Printer.mp4" />
        </div>
        <div className={styles.gridItem + ' ' + styles.text}>
          {/* <img src="/placeholder/3.png" alt="Description of the image" /> */}
          <Video src="https://storage.cloud.google.com/fdfc-www-prod-001-media-www/images/pages/creative-sandbox/collections/jeff-koons/gallery/JK_Review_1.mp4" />
        </div>
        <div className={styles.gridItem + ' ' + styles.text}>
          {/* <img src="/placeholder/4.png" alt="Description of the image" /> */}
          <Video src="https://storage.cloud.google.com/fdfc-www-prod-001-media-www/images/pages/creative-sandbox/collections/jeff-koons/gallery/Computer%20Bunny_1.mp4" />
        ...
        <div className={styles.gridItem + ' ' + styles.text}>
          ...
          <Video src="https://storage.cloud.google.com/fdfc-www-prod-001-media-www/images/pages/creative-sandbox/collections/jeff-koons/gallery/Laptop.mp4" />
