  ...
  return (
    <div>
      ...
      <HeaderSection
        ...
        backgroundVideoSrc="https://storage.googleapis.com/fdfc-www-prod-001-media-www/images/pages/creative-sandbox/collections/rick-rubin/Rick_Rubin_Collection_Site_Background_Video.mp4"
      />
      <section className={styles.rickVideoSection} data-theme="light">
        <div className={styles.rickVideoDiv}>
          ...
          <div className={styles.squareDiv}>
            <img
              src="https://storage.googleapis.com/fdfc-www-prod-001-media-www/images/pages/creative-sandbox/collections/rick-rubin/RR_Homepage_Logo.gif"
              alt=""
            />
          </div>
        </div>
      ...
      <section className={styles.rickfullVideoSection}>
        <video autoPlay muted loop playsInline preload="auto">
          <source
            src="https://storage.googleapis.com/fdfc-www-prod-001-media-www/images/pages/creative-sandbox/collections/rick-rubin/Sizzle_DesignProgress_v04_16x9.mp4"
            type="video/mp4"
          />
      ...
      <WebsiteSection
        ...
        videoSrc="https://storage.googleapis.com/fdfc-www-prod-001-media-www/images/pages/creative-sandbox/collections/rick-rubin/RR_Tetragrammaton_1354x784_v7.mp4"
      ...
      <WebsiteSection
        ...
        videoSrc="https://storage.googleapis.com/fdfc-www-prod-001-media-www/images/pages/creative-sandbox/collections/rick-rubin/Transmission_Template_1354x784.mp4"
